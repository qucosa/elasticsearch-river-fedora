...
public class MatchPidPredicateTest {

    private final Predicate<IndexJob> predicate = new MatchPidPredicate("^test:\\d+$");
    ...
    @Test
    public void evaluatesToFalseIfPatternDoesNotMatch() {
